...
import insee.httpclient.InseeTokenResponse;
import insee.sirene.SirenInfoResponse;
...
class InseeHttpClientTest {
    ...
    void givenInvalidCredentials_whenPostToken_isBadRequest() {
        assertThrows(HttpClientException.class, () -> Mono.from(client.token(InseeConstant.CLIENT_CREDENTIALS)).block());
    }
